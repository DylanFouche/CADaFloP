    ...
    def test_histogram_bins_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_histo, carta_histo))
    ...
    def test_histogram_mean_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_mean, carta_mean))
    ...
    def test_histogram_standard_deviation_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_std, carta_std))
    ...
    def test_stats_sum_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_stats[0], carta_stats[0]))
    ...
    def test_stats_mean_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_stats[1], carta_stats[1]))
    ...
    def test_stats_sigma_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_stats[2], carta_stats[2]))
    ...
    def test_stats_min_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_stats[3], carta_stats[3]))
    ...
    def test_stats_max_correct(self):
        ...
        for test_file in self.TEST_FILES:
            with self.subTest(file=test_file):
                ...
                self.assertTrue(is_close(dask_stats[4], carta_stats[4]))
